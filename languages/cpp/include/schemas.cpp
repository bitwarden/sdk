...
namespace quicktype {
    ...
    class ClientSettings {
        ...
        private:
        boost::optional<std::string> api_url;
        boost::optional<DeviceType> device_type;
        boost::optional<std::string> identity_url;
        boost::optional<std::string> user_agent;

        public:
        /**
         * The api url of the targeted Bitwarden instance. Defaults to `https://api.bitwarden.com`
         */
        boost::optional<std::string> get_api_url() const { return api_url; }
        void set_api_url(boost::optional<std::string> value) { this->api_url = value; }

        /**
         * Device type to send to Bitwarden. Defaults to SDK
         */
        boost::optional<DeviceType> get_device_type() const { return device_type; }
        void set_device_type(boost::optional<DeviceType> value) { this->device_type = value; }

        /**
         * The identity url of the targeted Bitwarden instance. Defaults to
         * `https://identity.bitwarden.com`
         */
        boost::optional<std::string> get_identity_url() const { return identity_url; }
        void set_identity_url(boost::optional<std::string> value) { this->identity_url = value; }

        /**
         * The user_agent to sent to Bitwarden. Defaults to `Bitwarden Rust-SDK`
         */
        boost::optional<std::string> get_user_agent() const { return user_agent; }
        void set_user_agent(boost::optional<std::string> value) { this->user_agent = value; }
    };
    ...
    class Cipher {
        ...
        boost::optional<std::string> get_notes() const { return notes; }
        void set_notes(boost::optional<std::string> value) { this->notes = value; }
    ...
    class SendFile {
        ...
        const std::string & get_size() const { return size; }
        std::string & get_mutable_size() { return size; }
        void set_size(const std::string & value) { this->size = value; }

        /**
         * Readable size, ex: "4.2 KB" or "1.43 GB"
         */
        const std::string & get_size_name() const { return size_name; }
        std::string & get_mutable_size_name() { return size_name; }
        void set_size_name(const std::string & value) { this->size_name = value; }
    };

    class SendText {
        public:
        SendText() = default;
        virtual ~SendText() = default;
    ...
    enum class SendType : int { FILE, TEXT };

    class Send {
        public:
        Send() :
            access_count_constraint(boost::none, boost::none, boost::none, boost::none, boost::none, boost::none, boost::none)
        {}
        virtual ~Send() = default;

        private:
        int64_t access_count;
        ClassMemberConstraints access_count_constraint;
        std::string access_id;
        std::string deletion_date;
        bool disabled;
        boost::optional<std::string> expiration_date;
        boost::optional<SendFile> file;
        bool hide_email;
        std::string id;
        std::string key;
        boost::optional<int64_t> max_access_count;
        std::string name;
        boost::optional<std::string> notes;
        boost::optional<std::string> password;
        std::string revision_date;
        boost::optional<SendText> text;
        SendType type;

        public:
        const int64_t & get_access_count() const { return access_count; }
        int64_t & get_mutable_access_count() { return access_count; }
        void set_access_count(const int64_t & value) { CheckConstraint("access_count", access_count_constraint, value); this->access_count = value; }

        const std::string & get_access_id() const { return access_id; }
        std::string & get_mutable_access_id() { return access_id; }
        void set_access_id(const std::string & value) { this->access_id = value; }

        const std::string & get_deletion_date() const { return deletion_date; }
        std::string & get_mutable_deletion_date() { return deletion_date; }
        void set_deletion_date(const std::string & value) { this->deletion_date = value; }
        ...
        boost::optional<std::string> get_expiration_date() const { return expiration_date; }
        void set_expiration_date(boost::optional<std::string> value) { this->expiration_date = value; }

        boost::optional<SendFile> get_file() const { return file; }
        void set_file(boost::optional<SendFile> value) { this->file = value; }

        const bool & get_hide_email() const { return hide_email; }
        bool & get_mutable_hide_email() { return hide_email; }
        void set_hide_email(const bool & value) { this->hide_email = value; }
        ...
        boost::optional<int64_t> get_max_access_count() const { return max_access_count; }
        void set_max_access_count(boost::optional<int64_t> value) { this->max_access_count = value; }
        ...
        boost::optional<std::string> get_password() const { return password; }
        void set_password(boost::optional<std::string> value) { this->password = value; }

        const std::string & get_revision_date() const { return revision_date; }
        std::string & get_mutable_revision_date() { return revision_date; }
        void set_revision_date(const std::string & value) { this->revision_date = value; }

        boost::optional<SendText> get_text() const { return text; }
        void set_text(boost::optional<SendText> value) { this->text = value; }

        const SendType & get_type() const { return type; }
        SendType & get_mutable_type() { return type; }
        void set_type(const SendType & value) { this->type = value; }
    };

    class SendListView {
        public:
        SendListView() = default;
        virtual ~SendListView() = default;
    ...
    class SendFileView {
        public:
        SendFileView() = default;
        virtual ~SendFileView() = default;
    ...
    class SendTextView {
        public:
        SendTextView() = default;
        virtual ~SendTextView() = default;
    ...
    class SendView {
        ...
        bool disabled;
        boost::optional<std::string> expiration_date;
        boost::optional<SendFileView> file;
        bool hide_email;
        std::string id;
        std::string key;
        boost::optional<int64_t> max_access_count;
        ...
        boost::optional<std::string> password;
        std::string revision_date;
        boost::optional<SendTextView> text;
        SendType type;
        ...
        boost::optional<SendFileView> get_file() const { return file; }
        void set_file(boost::optional<SendFileView> value) { this->file = value; }
        ...
        boost::optional<SendTextView> get_text() const { return text; }
        void set_text(boost::optional<SendTextView> value) { this->text = value; }
    ...
    class DocRef {
        ...
        boost::optional<Send> send;
        boost::optional<SendView> send_view;
        boost::optional<SendListView> send_list_view;
        ...
        boost::optional<Send> get_send() const { return send; }
        void set_send(boost::optional<Send> value) { this->send = value; }

        boost::optional<SendView> get_send_view() const { return send_view; }
        void set_send_view(boost::optional<SendView> value) { this->send_view = value; }

        boost::optional<SendListView> get_send_list_view() const { return send_list_view; }
        void set_send_list_view(boost::optional<SendListView> value) { this->send_list_view = value; }
...
void from_json(const json & j, SendFile & x);
void to_json(json & j, const SendFile & x);

void from_json(const json & j, SendText & x);
void to_json(json & j, const SendText & x);

void from_json(const json & j, Send & x);
void to_json(json & j, const Send & x);

void from_json(const json & j, SendListView & x);
void to_json(json & j, const SendListView & x);

void from_json(const json & j, SendFileView & x);
void to_json(json & j, const SendFileView & x);

void from_json(const json & j, SendTextView & x);
void to_json(json & j, const SendTextView & x);

void from_json(const json & j, SendView & x);
void to_json(json & j, const SendView & x);
...
void from_json(const json & j, SendType & x);
void to_json(json & j, const SendType & x);
}
namespace nlohmann {
template <>
...
namespace quicktype {
    inline void from_json(const json & j, ClientSettings& x) {
        x.set_api_url(get_stack_optional<std::string>(j, "apiUrl"));
        x.set_device_type(get_stack_optional<DeviceType>(j, "deviceType"));
        x.set_identity_url(get_stack_optional<std::string>(j, "identityUrl"));
        x.set_user_agent(get_stack_optional<std::string>(j, "userAgent"));
    }
    ...
    inline void from_json(const json & j, Cipher& x) {
        ...
        x.set_name(j.at("name").get<std::string>());
        x.set_notes(get_stack_optional<std::string>(j, "notes"));
    ...
    inline void from_json(const json & j, SendFile& x) {
        x.set_file_name(j.at("fileName").get<std::string>());
        x.set_id(j.at("id").get<std::string>());
        x.set_size(j.at("size").get<std::string>());
        x.set_size_name(j.at("sizeName").get<std::string>());
    }

    inline void to_json(json & j, const SendFile & x) {
        j = json::object();
        j["fileName"] = x.get_file_name();
        j["id"] = x.get_id();
        j["size"] = x.get_size();
    ...
    inline void from_json(const json & j, SendText& x) {
        x.set_hidden(j.at("hidden").get<bool>());
        x.set_text(j.at("text").get<std::string>());
    }

    inline void to_json(json & j, const SendText & x) {
        j = json::object();
        j["hidden"] = x.get_hidden();
        j["text"] = x.get_text();
    }

    inline void from_json(const json & j, Send& x) {
        x.set_access_count(j.at("accessCount").get<int64_t>());
        x.set_access_id(j.at("accessId").get<std::string>());
        x.set_deletion_date(j.at("deletionDate").get<std::string>());
        x.set_disabled(j.at("disabled").get<bool>());
        x.set_expiration_date(get_stack_optional<std::string>(j, "expirationDate"));
        x.set_file(get_stack_optional<SendFile>(j, "file"));
        x.set_hide_email(j.at("hideEmail").get<bool>());
        x.set_id(j.at("id").get<std::string>());
        x.set_key(j.at("key").get<std::string>());
        x.set_max_access_count(get_stack_optional<int64_t>(j, "maxAccessCount"));
        x.set_name(j.at("name").get<std::string>());
        x.set_notes(get_stack_optional<std::string>(j, "notes"));
        x.set_password(get_stack_optional<std::string>(j, "password"));
        x.set_revision_date(j.at("revisionDate").get<std::string>());
        x.set_text(get_stack_optional<SendText>(j, "text"));
        x.set_type(j.at("type").get<SendType>());
    }

    inline void to_json(json & j, const Send & x) {
        j = json::object();
        j["accessCount"] = x.get_access_count();
        j["accessId"] = x.get_access_id();
        j["deletionDate"] = x.get_deletion_date();
        j["disabled"] = x.get_disabled();
        j["expirationDate"] = x.get_expiration_date();
        j["file"] = x.get_file();
        j["hideEmail"] = x.get_hide_email();
        j["id"] = x.get_id();
        j["key"] = x.get_key();
        j["maxAccessCount"] = x.get_max_access_count();
        j["name"] = x.get_name();
        j["notes"] = x.get_notes();
        j["password"] = x.get_password();
        j["revisionDate"] = x.get_revision_date();
    ...
    inline void from_json(const json & j, SendListView& x) {
        x.set_access_id(j.at("accessId").get<std::string>());
        x.set_deletion_date(j.at("deletionDate").get<std::string>());
        x.set_disabled(j.at("disabled").get<bool>());
        x.set_expiration_date(get_stack_optional<std::string>(j, "expirationDate"));
    ...
    inline void to_json(json & j, const SendListView & x) {
        j = json::object();
        j["accessId"] = x.get_access_id();
        j["deletionDate"] = x.get_deletion_date();
        j["disabled"] = x.get_disabled();
    ...
    inline void from_json(const json & j, SendFileView& x) {
        x.set_file_name(j.at("fileName").get<std::string>());
        x.set_id(j.at("id").get<std::string>());
        x.set_size(j.at("size").get<std::string>());
        x.set_size_name(j.at("sizeName").get<std::string>());
    ...
    inline void to_json(json & j, const SendFileView & x) {
        j = json::object();
        j["fileName"] = x.get_file_name();
        j["id"] = x.get_id();
        j["size"] = x.get_size();
    ...
    inline void from_json(const json & j, SendTextView& x) {
        x.set_hidden(j.at("hidden").get<bool>());
        x.set_text(j.at("text").get<std::string>());
    }

    inline void to_json(json & j, const SendTextView & x) {
        j = json::object();
        j["hidden"] = x.get_hidden();
        j["text"] = x.get_text();
    }

    inline void from_json(const json & j, SendView& x) {
        x.set_access_count(j.at("accessCount").get<int64_t>());
        x.set_access_id(j.at("accessId").get<std::string>());
        x.set_deletion_date(j.at("deletionDate").get<std::string>());
        x.set_disabled(j.at("disabled").get<bool>());
        x.set_expiration_date(get_stack_optional<std::string>(j, "expirationDate"));
        x.set_file(get_stack_optional<SendFileView>(j, "file"));
        x.set_hide_email(j.at("hideEmail").get<bool>());
        x.set_id(j.at("id").get<std::string>());
        x.set_key(j.at("key").get<std::string>());
        x.set_max_access_count(get_stack_optional<int64_t>(j, "maxAccessCount"));
        ...
        x.set_password(get_stack_optional<std::string>(j, "password"));
        x.set_revision_date(j.at("revisionDate").get<std::string>());
        x.set_text(get_stack_optional<SendTextView>(j, "text"));
        x.set_type(j.at("type").get<SendType>());
    }

    inline void to_json(json & j, const SendView & x) {
        j = json::object();
        j["accessCount"] = x.get_access_count();
        j["accessId"] = x.get_access_id();
        j["deletionDate"] = x.get_deletion_date();
    ...
    inline void from_json(const json & j, DocRef& x) {
        ...
        x.set_send(get_stack_optional<Send>(j, "Send"));
        x.set_send_view(get_stack_optional<SendView>(j, "SendView"));
        x.set_send_list_view(get_stack_optional<SendListView>(j, "SendListView"));
    ...
    inline void to_json(json & j, const DocRef & x) {
        ...
        j["Send"] = x.get_send();
        j["SendView"] = x.get_send_view();
        j["SendListView"] = x.get_send_list_view();
    ...
    inline void from_json(const json & j, SendType & x) {
        if (j == "File") x = SendType::FILE;
        else if (j == "Text") x = SendType::TEXT;
        else { throw std::runtime_error("Input JSON does not conform to schema!"); }
    }

    inline void to_json(json & j, const SendType & x) {
        switch (x) {
            case SendType::FILE: j = "File"; break;
            case SendType::TEXT: j = "Text"; break;
            default: throw std::runtime_error("This should not happen");
        }
    }
}
