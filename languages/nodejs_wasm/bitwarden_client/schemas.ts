// To parse this data:
//
//   import { Convert, ClientSettings, Command, ResponseForAPIKeyLoginResponse, ResponseForDecryptPerformanceResponse, ResponseForPasswordLoginResponse, ResponseForSecretIdentifiersResponse, ResponseForSecretResponse, ResponseForSecretsDeleteResponse, ResponseForSyncResponse, ResponseForUserAPIKeyResponse } from "./file";
//
...
//   const responseForDecryptPerformanceResponse = Convert.toResponseForDecryptPerformanceResponse(json);
...
export interface DecryptPerformanceRequest {
    cipherText:    string;
    key:           string;
    numOperations: number;
}

export interface EncryptPerformanceRequest {
    key:           string;
    numOperations: number;
}

export interface Pbkdf2PerformanceRequest {
    numOperations: number;
    password:      string;
}
...
export interface ResponseForDecryptPerformanceResponse {
    /**
     * The response data. Populated if `success` is true.
     */
    data?: DecryptPerformanceResponse | null;
    /**
     * A message for any error that may occur. Populated if `success` is false.
     */
    errorMessage?: null | string;
...
export interface DecryptPerformanceResponse {
    clearText: string[];
}
...
export class Convert {
    ...
    public static toResponseForDecryptPerformanceResponse(json: string): ResponseForDecryptPerformanceResponse {
        return cast(JSON.parse(json), r("ResponseForDecryptPerformanceResponse"));
    }

    public static responseForDecryptPerformanceResponseToJson(value: ResponseForDecryptPerformanceResponse): string {
        return JSON.stringify(uncast(value, r("ResponseForDecryptPerformanceResponse")), null, 2);
    }
...
const typeMap: any = {
    ...
    "Command": o([
        ...
        { json: "performance", js: "performance", typ: u(undefined, r("PerformanceCommand")) },
    ...
    "PerformanceCommand": o([
        { json: "decrypt", js: "decrypt", typ: u(undefined, r("DecryptPerformanceRequest")) },
        { json: "encrypt", js: "encrypt", typ: u(undefined, r("EncryptPerformanceRequest")) },
        { json: "pbkdf2", js: "pbkdf2", typ: u(undefined, r("Pbkdf2PerformanceRequest")) },
    ], false),
    "DecryptPerformanceRequest": o([
        { json: "cipherText", js: "cipherText", typ: "" },
        { json: "key", js: "key", typ: "" },
        { json: "numOperations", js: "numOperations", typ: 0 },
    ], false),
    "EncryptPerformanceRequest": o([
        { json: "key", js: "key", typ: "" },
        { json: "numOperations", js: "numOperations", typ: 0 },
    ], false),
    "Pbkdf2PerformanceRequest": o([
        { json: "numOperations", js: "numOperations", typ: 0 },
        { json: "password", js: "password", typ: "" },
    ], false),
    "ProjectsCommand": o([
    ...
    "ResponseForDecryptPerformanceResponse": o([
        { json: "data", js: "data", typ: u(undefined, u(r("DecryptPerformanceResponse"), null)) },
        { json: "errorMessage", js: "errorMessage", typ: u(undefined, u(null, "")) },
        { json: "success", js: "success", typ: true },
    ], false),
    "DecryptPerformanceResponse": o([
        { json: "clearText", js: "clearText", typ: a("") },
    ], false),
