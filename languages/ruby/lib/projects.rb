...
class ProjectsClient
  ...
  def create_project(project_name: String, organization_id: String)
    @command_runner.run(
  ...
  def list_projects(organization_id: String)
    @command_runner.run(
      SelectiveCommand.new(
        projects:
          SelectiveProjectsCommand.new(
  ...
  def update_project(id: String, project_put_request_name: String, organization_id: String)
    @command_runner.run(
      SelectiveCommand.new(
        projects:
          SelectiveProjectsCommand.new(
  ...
  def delete_projects(ids: Array[String])
    @command_runner.run(
      SelectiveCommand.new(
        projects:
          SelectiveProjectsCommand.new(
