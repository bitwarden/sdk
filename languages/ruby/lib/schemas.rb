...
#   puts doc_ref.kdf&.argon2_id&.iterations.even?
#
...
class Login < Dry::Struct
  ...
  attribute :uris,                   Types.Array(LoginURI)
  ...
  def self.from_dynamic!(d)
    ...
    new(
      ...
      totp:                   d["totp"],
      uris:                   d.fetch("uris").map { |x| LoginURI.from_dynamic!(x) },
...
class Cipher < Dry::Struct
  attribute :attachments,           Types.Array(Attachment)
  ...
  attribute :password_history,      Types.Array(PasswordHistory)
  ...
  def self.from_dynamic!(d)
    d = Types::Hash[d]
    new(
      attachments:           d.fetch("attachments").map { |x| Attachment.from_dynamic!(x) },
      ...
      password_history:      d.fetch("passwordHistory").map { |x| PasswordHistory.from_dynamic!(x) },
...
class FieldView < Dry::Struct
  attribute :linked_id,       Types::LinkedIDType.optional.optional
  attribute :field_view_name, Types::String
...
class LoginView < Dry::Struct
  ...
  attribute :password_revision_date, Types::String.optional.optional
  attribute :totp,                   Types::String.optional.optional
  attribute :uris,                   Types.Array(LoginURIView)
  attribute :username,               Types::String
  ...
  def self.from_dynamic!(d)
    ...
    new(
      ...
      password_revision_date: d["passwordRevisionDate"],
      totp:                   d["totp"],
      uris:                   d.fetch("uris").map { |x| LoginURIView.from_dynamic!(x) },
      username:               d.fetch("username"),
    )
  end
...
class CipherView < Dry::Struct
  attribute :attachments,           Types.Array(AttachmentView)
  ...
  attribute :edit,                  Types::Bool
  attribute :favorite,              Types::Bool
  attribute :fields,                Types.Array(FieldView)
  attribute :folder_id,             Types::String.optional.optional
  attribute :id,                    Types::String.optional.optional
  ...
  attribute :organization_id,       Types::String.optional.optional
  attribute :organization_use_totp, Types::Bool
  attribute :password_history,      Types.Array(PasswordHistoryView)
  attribute :reprompt,              Types::CipherRepromptType
  attribute :revision_date,         Types::String
  ...
  def self.from_dynamic!(d)
    d = Types::Hash[d]
    new(
      attachments:           d.fetch("attachments").map { |x| AttachmentView.from_dynamic!(x) },
      ...
      edit:                  d.fetch("edit"),
      favorite:              d.fetch("favorite"),
      fields:                d.fetch("fields").map { |x| FieldView.from_dynamic!(x) },
      folder_id:             d["folderId"],
      id:                    d["id"],
      ...
      organization_id:       d["organizationId"],
      organization_use_totp: d.fetch("organizationUseTotp"),
      password_history:      d.fetch("passwordHistory").map { |x| PasswordHistoryView.from_dynamic!(x) },
      reprompt:              d.fetch("reprompt"),
      revision_date:         d.fetch("revisionDate"),
...
class InitCryptoRequest < Dry::Struct
  ...
  def self.from_dynamic!(d)
    ...
    new(
      email:             d.fetch("email"),
      kdf_params:        Kdf.from_dynamic!(d.fetch("kdfParams")),
...
class DocRef < Dry::Struct
  ...
  def self.from_dynamic!(d)
    ...
    new(
      ...
      kdf:                            d["Kdf"] ? Kdf.from_dynamic!(d["Kdf"]) : nil,
    )
  end
